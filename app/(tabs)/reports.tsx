...
const reportCards = [
  {
    ...
    value: '126',
    insight: '+18% vs yesterday',
  },
  {
    title: 'Average Processing Time',
    value: '2.4h',
    insight: '-0.6h this week',
  },
  {
    title: 'Risk Alerts',
    value: '8',
    insight: '3 require immediate review',
  },
];
...
export default function ReportsScreen() {
  return (
    ...
    >
      <Text className="text-3xl font-bold text-[#eef5ff]">Reports</Text>
      <Text className="mt-1 text-sm text-[#8ea2bc]">
        Executive analytics for approval operations.
      </Text>
      ...
      <View className="mt-6 gap-3">
        {reportCards.map((card) => (
          <View
            key={card.title}
            className="rounded-2xl border border-[#1f3552] bg-[#0b1f39] p-4"
          >
