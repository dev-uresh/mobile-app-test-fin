  ...
  return (
    <View>
      <View className="flex-row items-center justify-between">
        <Pressable onPress={onMenuPress} className="h-10 w-10 items-center justify-center rounded-xl bg-[#0b2b4b]" hitSlop={8}>
          <Ionicons name="menu" size={20} color="#d6e8ff" />
        </Pressable>

        <Pressable onPress={onAlertsPress} className="h-10 w-10 items-center justify-center rounded-xl bg-[#0b2b4b]" hitSlop={8}>
      ...
      <Text className="mt-2 text-sm text-[#8ea2bc]" style={{ fontSize: 18 }}>{subtitle}</Text>
    </View>
  );
}
